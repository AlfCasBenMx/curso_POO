...
INPUT_CSV = BASE_DIR / "ejercicios" / "ventas_large.csv"   # o ventas.csv / ventas_sucio.csv
RULES_CSV = BASE_DIR / "ejercicios" / "reglas_impuesto.csv"
OUTPUT_CSV = BASE_DIR / "ejercicios" / "ventas_con_impuesto_motor.csv"
EXCEPTIONS_CSV = BASE_DIR / "ejercicios" / "ventas_excepciones_motor.csv"
