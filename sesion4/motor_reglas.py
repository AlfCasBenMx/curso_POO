...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default=str(base_dir / "ventas.csv"),
        help="Ruta del CSV de ventas (default: ventas.csv)",
    )
    parser.add_argument(
        "--rules",
        default=str(base_dir / "reglas_impuesto.csv"),
        help="Ruta del CSV de reglas (default: reglas_impuesto.csv)",
    )
    parser.add_argument(
        "--output",
        default=str(base_dir / "ventas_con_impuesto.csv"),
        help="Ruta del CSV de salida (default: ventas_con_impuesto.csv)",
    )
    parser.add_argument(
        "--exceptions",
        default=str(base_dir / "ventas_excepciones.csv"),
        help="Ruta del CSV de excepciones (default: ventas_excepciones.csv)",
    )
